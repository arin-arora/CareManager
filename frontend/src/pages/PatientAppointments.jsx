                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="text-[10px] text-slate-500 font-bold">
                        {app.doctor.designation || 'Consultant'} • {app.doctor.specialisation}
                      </p>
              ...
              <div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-950 border border-slate-150 dark:border-slate-900 rounded-xl space-y-1">
                  <p className="text-xs font-bold text-slate-700 dark:text-slate-350 flex items-center gap-1">
                    <User className="w-3.5 h-3.5 text-blue-500" /> Doctor: {selectedApp.doctor.user.name.startsWith('Dr.') ? selectedApp.doctor.user.name : `Dr. ${selectedApp.doctor.user.name}`}
                  </p>
                  <p className="text-[10px] text-slate-500 font-bold">Designation: {selectedApp.doctor.designation || 'Consultant'}</p>
